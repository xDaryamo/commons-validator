...
//        ERROR_VPAY2,
    ...
    public void testDinersValidator() {
        ...
        // Test Regular Expression
        assertFalse("Invalid Length", regex.isValid("300456789012"));
        assertTrue("Length 14-300", regex.isValid("30045678901234"));
        assertTrue("Length 14-36", regex.isValid("36345678901234"));
        assertFalse("Invalid Length", regex.isValid("300456789012345"));
        assertFalse("Invalid Length", regex.isValid("363456789012345"));
        assertFalse("Invalid Length", regex.isValid("3004567890123456"));
        assertFalse("Invalid Length", regex.isValid("3634567890123456"));

        assertTrue("Prefix 300-305", regex.isValid("30045678901234"));
        assertTrue("Prefix 3095", regex.isValid("30955678901234"));
        assertTrue("Prefix 36-38", regex.isValid("36345678901234"));
        assertTrue("Prefix 36-38", regex.isValid("38345678901234"));

        assertFalse("Invalid Char", regex.isValid("3004567x901234"));
        assertFalse("Invalid Char", regex.isValid("3634567x901234"));
    ...
    public void testDiscoverValidator() {
        ...
        // Test Regular Expression
        assertFalse("Invalid Length", regex.isValid("601156789012"));
        assertFalse("Invalid Length", regex.isValid("653456789012"));
    ...
    public void testMastercardValidator() {
        ...
        // Test Regular Expression
        assertFalse("Invalid Length", regex.isValid("513456789012"));
        assertTrue("Length 16", regex.isValid("5134567890123456"));
        assertTrue("Prefix 51-55", regex.isValid("5134567890123456"));
        assertTrue("Prefix 51-55", regex.isValid("5234567890123456"));
        assertTrue("Prefix 51-55", regex.isValid("5334567890123456"));
        assertTrue("Prefix 51-55", regex.isValid("5434567890123456"));
        assertTrue("Prefix 51-55", regex.isValid("5534567890123456"));
    ...
    public void testVisaValidator() {
        ...
        // Test Regular Expression
        assertFalse("Invalid Length", regex.isValid("423456789012"));
